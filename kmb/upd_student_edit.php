	...
	if($_SESSION['uname'] != NULL && $_SESSION['upass'] != NULL)
		...
		$logname = $_SESSION['uname'];
			...
			$eid =$_GET['eid'];
				if($eid == TRUE)
					{
					$sql="select * from sinfo where id='$eid' ";
		...
		if($_POST['Submit'] != NULL)
			{
				...
				if($troll <= '1')
					{
						$sql="update sinfo set name='$sname', fname='$fname', mname='$mname', roll='$roll', reg='$reg', sesson='$sesson', tech='$tech', gender='$gender', address='$address', sphone='$sphone', gphone='$gphone' where id=$eid";
					$query=mysql_query($sql);
						 	...
						 	<div class="das-top">
								<div class="das-bot">
							      ...
							      <div class="das-icon-bord">
							        <p>&nbsp;</p>
							        <p>&nbsp;</p>
							        <form id="form1" name="form1" method="post" action="<?php echo $_SELF ;?>"   onsubmit="return validateForm(this)">
							         
							          <table width="100%" border="0" cellpadding="0" cellspacing="5">
                                        <tr bgcolor="#CC9966">
                                          <td colspan="3"><div align="center"><span class="style18">UpDate Registation Form </span></div></td>
                                        </tr>
                                        <tr>
                                          <td width="162">&nbsp;</td>
                                          <td width="24">&nbsp;</td>
                                        ...
                                        <tr>
                                          ...
                                          <td><input type="text" name="sname" value="<?php echo $row[name]; ?>" style="border:solid 1px #666666;width:200px;" />
                                        ...
                                        <tr>
                                          ...
                                          <td><input type="text" name="fname" value="<?php echo $row[fname]; ?>" style="border:solid 1px #666666;width:200px;"/></td>
                                        </tr>
                                        <tr>
                                          <td><div align="right" class="style9">Mother's Name 	</div></td>
                                          <td><div align="center" class="style15"><span class="style3">:</span></div></td>
                                          <td><input type="text" name="mname" value="<?php echo $row[mname]; ?>" style="border:solid 1px #666666;width:200px;"/></td>
                                        </tr>
                                        <tr>
                                          <td><div align="right" class="style9"> Roll No </div></td>
                                          <td><div align="center" class="style15"><span class="style3">:</span></div></td>
                                          <td><input type="text" name="roll" value="<?php echo $row[roll]; ?>" style="border:solid 1px #666666;width:200px;"/>
                                            <span class="style16"> *</span></td>
                                        </tr>
                                        <tr>
                                          <td><div align="right" class="style9">Registation No 	</div></td>
                                          <td><div align="center" class="style15"><span class="style3">:</span></div></td>
                                          <td><input type="text" name="reg" value="<?php echo $row[reg]; ?>" style="border:solid 1px #666666;width:200px;"/></td>
                                        </tr>
                                        <tr>
                                          <td><div align="right" class="style9">Sesson</div></td>
                                          <td><div align="center" class="style15"><span class="style3">:</span></div></td>
                                          <td><select name="sesson" style="border:solid 1px #666666;width:200px;">
                                          <option><?php echo $row[sesson]; ?></option>
                                        ...
                                        <tr>
										  ...
										  <option><?php echo $row[tech]; ?></option>
                                        ...
                                        <tr>
                                          ...
                                          <input name="gender" type="radio" value="<?php echo $row[gender]; ?>" />
                                        ...
                                        <tr>
                                          ...
                                          <td><div align="center" class="style15"><span class="style3">:</span></div></td>
                                          <td><textarea name="address" style="border:solid 1px #666666;width:200px;"><?php echo 
										  $row[address]; ?></textarea></td>
                                        </tr>
                                        <tr>
                                          <td><div align="right" class="style9">Student Phone No </div></td>
                                          <td><div align="center" class="style15"><span class="style3">:</span></div></td>
                                          <td><input type="text" name="sphone" value="<?php echo $row[sphone]; ?>" style="border:solid 1px #666666;width:200px;" /></td>
                                        </tr>
                                        <tr>
                                          <td><div align="right" class="style9">Gardian Phone No 	</div></td>
                                          <td><div align="center" class="style15"><span class="style3">:</span></div></td>
                                          <td><input type="text" name="gphone" value="<?php echo $row[ gphone]; ?>"style="border:solid 1px #666666;width:200px;"/></td>
                                        </tr>
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td>&nbsp;</td>
                                          <td><input name="Submit" type="submit" class="style9" style="border:solid 1px #666666;width:80px;background:#999966;" value="Save"/></td>
                                        </tr>
                                        <tr>
                                          <td class="style9">&nbsp;</td>
                                          <td>&nbsp;</td>
